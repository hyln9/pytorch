...
class GraphLowering(torch.fx.Interpreter):
    ...
    def run_node(self, n: torch.fx.Node) -> object:
        ...
        def mark_use_channels_last_layout(result: ir.TensorBox, n: torch.fx.Node) -> ir.TensorBox:
        ...
        with (
            ...
            if num_users > 1 and isinstance(result, TensorBox):
                ...
                while hasattr(data, "data") and not isinstance(data, StorageBox):
                    data = data.data
                if isinstance(data, StorageBox) and data.should_realize_on_reuse(len(n.users)):
